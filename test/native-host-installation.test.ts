...
test('native host installation receipt accepts exactly the recorded provenance, identities, paths, and hashes', () => {
  ...
  assert.equal(NATIVE_HOST_ACCEPTED_SOURCE_SHA, 'fd60c602dfe84ddf05b7e1575e77f45eb2c56b9d');
  assert.equal(NATIVE_HOST_ACCEPTED_EXECUTABLE_SHA256, '0349fbe41bc31c9685bd0f64431a517b34f600f614123d94582a47dc8e8a40cf');
  assert.equal(NATIVE_HOST_ACCEPTED_WORKFLOW_RUN_ID, '34757274244');
